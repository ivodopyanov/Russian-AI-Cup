public interface Constants
{
    ...
    //Оценка ожидания хода медика, когда нужно лечение и он рядом
    double WAIT_FOR_MEDIC = 15.0;
